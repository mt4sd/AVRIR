...
namespace Mirror
{
    public abstract class NetworkTransformBase : NetworkBehaviour
    {
        ...
        [Range(0, 1)] public float sendInterval = 0.010f;
        ...
        protected SortedList<double, NTSnapshot> serverBuffer = new SortedList<double, NTSnapshot>();
        protected SortedList<double, NTSnapshot> clientBuffer = new SortedList<double, NTSnapshot>();
