...
namespace Mirror
{
    ...
    {
        private LoadSceneMode loadSceneMode = LoadSceneMode.Single; // LoadSceneMode.Additive;
        ...
        public static bool IsSceneActive(string scene)
        {
            for (int i = 0; i<SceneManager.sceneCount; i++)
            {
                ...
                if (activeScene.path == scene || activeScene.name == scene)
                    return true;
            }
            return false;
        }
        ...
        public virtual void ServerChangeScene(string newSceneName)
        {
            ...
            loadingSceneAsync = SceneManager.LoadSceneAsync(newSceneName, loadSceneMode);
