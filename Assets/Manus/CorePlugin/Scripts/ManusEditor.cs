...
namespace Manus.Editor
{
	...
	public class ManusEditor
	{
		...
		static bool s_AutoManageDefines = false;//true;
		...
		const string s_DefineManusEnabled = "MANUS_ENABLED";
		...
		public static void TrySettingSteamVRDefine()
		{
			...
			if (!ProjectContainsDefine(s_DefineManusEnabled))
			{
				SetScriptingDefine(s_DefineManusEnabled);
			}
		}
